...
## Data input ------------------------------------------------------------------
# Use the cached scatterplot table. Run scripts/10_build_imf_weo_ppp_scatter_data.R
...
if (!file.exists(imf_ppp_scatter_path)) {
  stop(
    sprintf(
      "Missing `%s`. Run scripts/10_build_imf_weo_ppp_scatter_data.R once before graphing.",
